...
def test_plan_task_succeeds(monkeypatch):
    async def fake_plan(request, *, retriever=None, run_id=None, tenant_id=None, on_event=None):
        return Itinerary(
...
def test_plan_task_records_failure(monkeypatch):
    async def boom(request, *, retriever=None, run_id=None, tenant_id=None, on_event=None):
...
def test_trip_task_succeeds(monkeypatch):
    async def fake_trip(request, *, retriever=None, run_id=None, tenant_id=None, on_event=None):
